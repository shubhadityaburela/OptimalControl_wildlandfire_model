...
#%% Solve for sigma
impath = "./data/PODG/adaptive/"
immpath = "./plots/PODG_1D/adaptive/"
...
for opt_step in range(max_opt_steps):
    ...
    f, J_opt, dL_du, refine, stag = Update_Control_PODG(f, a_p, as_adj, qs_target, V_p, Ar_p, V_a, psir_p, psi, J, omega,
